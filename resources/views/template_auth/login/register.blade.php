...
<form method='POST' action='{{ url('register') }}' action-verify-user="{{ url('user/verify') }}">
  ...
  <div class="material-design">    
    <input type='text' class="verify-user" name="idtel"  aria-describedby="idtel" autocomplete='off' required>      
    <span class='bar'></span> 
  ...
  <div class="material-design">    
    <input type='email' class="" name="email"  aria-describedby="email" autocomplete='off' required>      
    <span class='bar'></span> 
  ...
  <div class="material-design">    
    <input type='password' class="" name="password"  aria-describedby="passwd" autocomplete='off' required>      
    <span class='bar'></span> 
